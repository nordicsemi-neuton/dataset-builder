...
- [Domain principles — inertial data prep & modeling](principles/domain.md) — P-01..P-13: window survival, training/inference shift, contiguous labels, single sampling rate, centering, direction features, postprocessing ceiling, EMA default, preprocessing parity, idle/unknown class, sensor-scale reconciliation, measured feature enable-set, metric is evaluation-only. _Updated: 2026-07-10_
