...
- [ADR-0002 — data-builder engine architecture](decisions/adr-0002-data-builder-engine-architecture.md) — two-layer validation (raw-bytes + dataframe), Finding/Report/verdict taxonomy, refuse-on-loss, flag-never-truncate, numpy/pandas-only. _Updated: 2026-06-25_
...
- [platform — Neuton neural-network framework](discovery/platform-neuton-framework.md) — neuron-by-neuron growth, patented global optimization, vs traditional/NAS; minimal inputs (data+target+metric). _Updated: 2026-06-25_
